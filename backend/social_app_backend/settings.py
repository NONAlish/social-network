...
SECRET_KEY = 'django-insecure-3ek@u8ez#mz2608i=e346l=i8t2zd6^f2%al@)0^-(^hti1lrg'
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'API documentation for Social Productivity App ',
    'VERSION': '1.0.0',
...
EMAIL_HOST_PASSWORD = 'rkpi xlqn hkzo tyxo'
