    ...
    <div className={`fixed w-[400px] bg-dark-blue p-6 rounded-lg shadow-lg`}>
      ...
      <form onSubmit={handleSubmit}>
        <div className="flex items-center justify-between mb-4">
          <label htmlFor="email" className="text-white text-lg w-[100px]">
            Enter Email:
          </label>
        ...
        <button type="button" onClick={() => navigateToAuth('singin')}>Back</button>
        <button type="submit" className="ml-4" >Next</button>
      </form>
    </div>
  );
};
